...
def characterModel(weights_path = None):
    ...
    # convolution layers
    model.add_node(Convolution2D(64, 1, 1, activation='relu', W_regularizer=l2(0.01)), name='c1', input='image')
    
    # two fully-connected layers
    model.add_node(Flatten(), name='f', input='c1')
    model.add_node(Dense(1024, activation='relu', W_regularizer=l2(0.01)), name='d1', input='f')
